 ...
 * Categories come from the foods.json data: Protein, Protein Dense, Fibre,
 * Fibre & RS, Leafy Volume, Volume, Thermogenic, Fat Quality, Fermented & Gut,
 * VAT Powerhouse. Anything unknown falls back to "default".
 */
...
export function foodTypeKind(t: string | undefined): FoodTypeKind {
  ...
  if (k.includes("fibre") || k.includes("fiber") || k.includes("rs"))
    return "fibre";
...
/** Short label used for tooltip + screen-reader aria-label fallback. */
