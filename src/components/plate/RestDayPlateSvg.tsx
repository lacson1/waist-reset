export function RestDayPlateSvg() {
  return (
    <svg viewBox="0 0 200 200" className="plate-svg" aria-hidden>
      ...
      <path d="M 100 100 L 100 192 A 92 92 0 0 1 8 100 Z" fill="#f6e1d5" opacity="0.85" />
      <path d="M 100 100 L 8 100 A 92 92 0 0 1 100 8 Z" fill="#f7ecc7" opacity="0.85" />
      ...
      <text x="60" y="155" fontSize="12" fontWeight="600" fill="var(--text-primary)">
        ¼ Protein
      </text>
      <text x="35" y="55" fontSize="12" fontWeight="600" fill="var(--text-primary)">
        ¼ Fibre
      </text>
    </svg>
  )
