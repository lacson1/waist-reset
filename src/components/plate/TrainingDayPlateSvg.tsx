...
export function TrainingDayPlateSvg({ activeSlot, interactive, onSlotSelect, slotPicks }: Props) {
    ...
    >
      ...
      <g clipPath={`url(#${g('clip-carbs')})`}>
        <PlateRoundWedgeLabels
          ...
          titleY={70}
          title="¼ Carbs"
          lines={slotPicks?.carbs}
          titleClassName="plate-svg-label plate-svg-label--imprint plate-svg-label--imprint-slate"
